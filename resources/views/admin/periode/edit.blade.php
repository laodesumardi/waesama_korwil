            ...
            <form action="{{ route('admin.periode.update', $periode->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="tahun_ajaran" class="form-select @error('tahun_ajaran') is-invalid @enderror" required>
                            ...
                            @foreach($tahunAjaranOptions as $option)
                                <option value="{{ $option }}" {{ old('tahun_ajaran', $periode->tahun_ajaran) == $option ? 'selected' : '' }}>
                                    {{ $option }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror" value="{{ old('tanggal_mulai', $periode->tanggal_mulai->format('Y-m-d')) }}" required>
                        @error('tanggal_mulai')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" name="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror" value="{{ old('tanggal_selesai', $periode->tanggal_selesai->format('Y-m-d')) }}" required>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1" {{ old('is_active', $periode->is_active) ? 'checked' : '' }}>

            ...
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if($user->foto)
                            <div class="mb-2">
                                <img src="{{ Storage::url($user->foto) }}" width="60" height="60" class="rounded-circle" style="object-fit: cover;">
                            </div>
                        @endif
                    ...
                    <div class="col-md-6 mb-3" id="assignment_sekolah_field" style="display: none;">
                        ...
                        <select name="assignment_sekolah_id" class="form-select">
                            ...
                            @foreach($sekolahList as $sekolah)
                                <option value="{{ $sekolah->id }}" {{ old('assignment_sekolah_id', $currentSekolahId) == $sekolah->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3" id="assignment_korwil_field" style="display: none;">
                        ...
                        <select name="assignment_korwil_id" class="form-select">
                            ...
                            @foreach($korwilList as $korwil)
                                <option value="{{ $korwil->id }}" {{ old('assignment_korwil_id', $currentKorwilId) == $korwil->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="is_active" class="form-check-input" id="is_active" value="1" {{ old('is_active', $user->is_active ? '1' : '0') == '1' ? 'checked' : '' }}>

                ...
                <div class="card-body">
                    @if($sudahInput)
                        <div class="alert alert-warning">
                            ...
                            Anda sudah menginput absensi guru hari ini. Input hanya dapat dilakukan satu kali per hari.
                        </div>
                    ...
                    @else
                        <form action="{{ route('operator.absensi.guru.store') }}" method="POST" enctype="multipart/form-data" id="absensiForm">
                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group w-100" role="group">
                                                    <input type="radio"
                                                           class="btn-check"
                                                           name="kehadiran[{{ $guru->id }}]"
                                                           id="hadir_{{ $guru->id }}"
                                                           value="hadir"
                                                           autocomplete="off"
                                                           checked>
                                                    <label class="btn btn-outline-success" for="hadir_{{ $guru->id }}">
                                                    ...
                                                    <input type="radio"
                                                           ...
                                                           value="izin"
                                                           autocomplete="off">
                                                    <label class="btn btn-outline-warning" for="izin_{{ $guru->id }}">
                                                    ...
                                                    <input type="radio"
                                                           ...
                                                           value="alpha"
                                                           autocomplete="off">
                                                    <label class="btn btn-outline-danger" for="alpha_{{ $guru->id }}">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label class="form-label fw-semibold">Foto Dokumentasi (Foto Guru yang Hadir)</label>
                                    ...
                                    <small class="text-muted">Ambil foto guru yang sedang mengajar sebagai dokumentasi</small>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    capturePhotoBtn.addEventListener('click', function() {
        ...
        canvas.toBlob(function(blob) {
            const file = new File([blob], "foto_absensi_guru.jpg", { type: "image/jpeg" });
